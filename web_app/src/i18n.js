...
const messages = {
  en: {
    ...
    'games.category': 'Category (optional)', 'games.playMode': 'Play mode', 'games.playMode.competitive': 'Competitive', 'games.playMode.cooperative': 'Cooperative', 'games.add': 'Add game', 'games.scoreCategories': 'Score categories', 'games.scoreCategory': 'Score category', 'games.addScoreCategory': 'Add score category', 'games.removeScoreCategory': 'Remove score category', 'games.categoryScoring': 'Category entry', 'games.perRound': 'Per round', 'games.finalCategoryTotal': 'Final totals', 'games.search': 'Search games', 'games.categoryFilter': 'Filter by category', 'games.allCategories': 'All categories', 'games.uncategorized': 'Uncategorized', 'games.noMatches': 'No games match these filters.', 'games.builtin': 'Built-in',
    ...
    'errors.categoryTooLong': 'Category must be 40 characters or fewer.', 'errors.scoreCategoryTooLong': 'Score category must be 40 characters or fewer.', 'errors.scoreCategoryDuplicate': 'Score category names must be unique.', 'errors.playModeUnknown': 'Unknown play mode.', 'errors.categoryScoringUnknown': 'Unknown category scoring mode.', 'errors.categoryScoringMismatch': 'Category scoring must match the selected entry mode.', 'errors.categoryEngineInvalid': 'Winner-only games cannot use score categories.', 'errors.cooperativeEngineInvalid': 'Cooperative games must use winner-only scoring.',
  ...
  nl: {
    ...
    'games.name': 'Spelnaam',
    'games.category': 'Categorie (optioneel)', 'games.playMode': 'Spelmodus', 'games.playMode.competitive': 'Competitief', 'games.playMode.cooperative': 'Coöperatief', 'games.add': 'Spel toevoegen', 'games.scoreCategories': 'Scorecategorieën', 'games.scoreCategory': 'Scorecategorie', 'games.addScoreCategory': 'Scorecategorie toevoegen', 'games.removeScoreCategory': 'Scorecategorie verwijderen', 'games.categoryScoring': 'Categorie-invoer', 'games.perRound': 'Per ronde', 'games.finalCategoryTotal': 'Eindtotaal', 'games.search': 'Spellen zoeken', 'games.categoryFilter': 'Filter op categorie', 'games.allCategories': 'Alle categorieën', 'games.uncategorized': 'Zonder categorie', 'games.noMatches': 'Geen spellen gevonden met deze filters.', 'games.builtin': 'Ingebouwd',
    ...
    'errors.categoryTooLong': 'De categorie mag maximaal 40 tekens bevatten.', 'errors.scoreCategoryTooLong': 'De scorecategorie mag maximaal 40 tekens bevatten.', 'errors.scoreCategoryDuplicate': 'Scorecategorienamen moeten uniek zijn.', 'errors.playModeUnknown': 'Onbekende spelmodus.', 'errors.categoryScoringUnknown': 'Onbekende categorie-invoer.', 'errors.categoryScoringMismatch': 'Categorie-invoer moet overeenkomen met de invoermethode.', 'errors.categoryEngineInvalid': 'Winner-only-spellen kunnen geen scorecategorieën gebruiken.', 'errors.cooperativeEngineInvalid': 'Coöperatieve spellen moeten winner-only-score gebruiken.',
